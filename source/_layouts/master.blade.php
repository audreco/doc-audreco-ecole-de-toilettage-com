...
<html lang="en">
    <head>
        ...
        <meta property="og:image" content="https://ecole-de-toilettage.com/assets/img/tmp-img/audreco-logo.jpg"/>
        ...
        <meta name="twitter:image" content="https://ecole-de-toilettage.com/assets/img/tmp-img/audreco-logo.jpg" />
    ...
    <body itemscope itemtype="https://schema.org/EducationalOrganization" class="flex flex-col justify-between min-h-screen bg-gray-100 text-gray-800 leading-normal font-sans">
        ...
        <footer class="bg-white text-center text-sm mt-12 py-4" role="contentinfo">
            <p><a itemprop="url" href="https://ecole-de-toilettage.com">École de toilettage</a> est un site de <a href="https://audreco.com/?utm_source=ecole+de+toilettage+com" target="_blank">l'École des Métiers de l'Animal de Compagnie</a><br />&copy; <a href="https://audreco.com/?utm_source=ecole+de+toilettage+com" title="Audreco">Audreco</a> 2020. Built with <a href="http://jigsaw.tighten.co" title="Jigsaw by Tighten">Jigsaw</a> and <a href="https://tailwindcss.com" title="Tailwind CSS, a utility-first CSS framework">Tailwind CSS</a> <a href="https://github.com/audreco/doc-audreco-ecole-de-toilettage-com" title="Source code for this website">< ></a>.</p>
        </footer>
    </body>
</html>
